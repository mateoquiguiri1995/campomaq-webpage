  ...
  return (
    <div
      className="
        ...
        hover:border-gray-200 flex flex-col
        h-[430px] md:h-[460px] lg:h-[480px] /* altura consistente */
      "
    >
      {/* Badges */}
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        <button
          onClick={handleQuote}
          className="w-full bg-green-500 hover:bg-green-600 text-white font-bold text-xs sm:text-sm py-2 sm:py-3 px-3 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-sm hover:shadow-lg transform hover:scale-[1.02]"
        >
          <svg
            className="w-4 h-4"
            fill="currentColor"
